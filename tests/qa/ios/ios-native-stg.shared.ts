...
export const SSO_ID = `//XCUIElementTypeButton[@name="본인 확인된 T ID pleasep@naver.com 010-8832-0456 로 로그인"]`;
...
export async function waitUntilInstalledAndActivated(driver: Browser, bundleId: string, timeoutMs = 300000, pollMs = 3000) {
...
export async function defaultBeforeEach(driver: Browser, testInfo: BasicTestInfo, skipTitles: string[] = []) {
